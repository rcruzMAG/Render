...
def flux_txt2img(p: dict) -> dict:
    ...
    variant = "flux_schnell_unet" if p.get("model") == "flux-schnell" else "flux_dev_unet"
    g = {
        "1": {"class_type": "UNETLoader",
              "inputs": {"unet_name": model(variant), "weight_dtype": "fp8_e4m3fn"}},
    ...
    nid, m, c = _apply_loras(g, 10, ["1", 0], ["2", 0], p.get("loras"))
    g.update({
...
CONTROLNETS = {"depth": "controlnet_depth", "canny": "controlnet_canny",
               "mlsd": "controlnet_mlsd"}
